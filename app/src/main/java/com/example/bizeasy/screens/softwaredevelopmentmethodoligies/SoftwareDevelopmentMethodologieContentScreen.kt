package com.example.bizeasy.screens.softwaredevelopmentmethodoligies
...
@Composable
fun SoftwareDevelopmentMethodologiesContentScreen () {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("softwaredevelopmentMethodologies") }
            )
        }
    ) { innerPadding ->
        Column(
